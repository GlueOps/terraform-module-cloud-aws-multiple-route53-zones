...
locals {
  ...
  argocd_helm_chart_version = "7.7.22"
  glueops_platform_version  = "v0.54.3" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
